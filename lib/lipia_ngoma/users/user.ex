defmodule LipiaNgoma.Users.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, LipiaNgoma.Repo)
  ...
  """
  def valid_password?(%LipiaNgoma.Users.User{hashed_password: hashed_password}, password)
